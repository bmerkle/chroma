...
from chromadb.api.configuration import (
    ...
    EmbeddingsQueueConfigurationInternal, HNSWConfigurationInternal, ConfigurationDefinition,
)
...
def _patch_hnsw_params_in_metadata(collection: strategies.Collection) -> None:
    # chroma 0.5.11 moved HNSW parameters from the collection metadata into the collection configuration
...
version_patches: List[
    ...
    ("0.5.11", _patch_hnsw_params_in_metadata)
]
